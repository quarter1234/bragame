...
/*		var data = {
        ...
        var yopentime = yopentimes_arr[1];
				html += '<div class="pl3zs8899"><div class="pl3qs8899"width="130">'+openinfo.expect+'</div><div class="qihao8899"><span width="46" class="c_red1 fb" style="padding:5px;">'+parseInt(array[0])+'</span><span width="46" class="c_red1 fb" style="padding:5px;">'+parseInt(array[1])+'</span><span width="46" class="c_red1 fb" style="padding:5px;">'+parseInt(array[2])+'</span></div><span class="" width="40" class="c_blue fb " style="width: 18%;text-align: center;float: left;min-height: 30px;line-height: 40px;word-wrap: break-word;">'+yopentime+'</span></div>';
            ...
            if (msg.sign == true) {
                if (msg.data.opencode.length > 0) {
                    ...
                    if (lastExpect == openexpect) {
                        ...
                        var yopentimes_arr = yopentimes.split(' ');
                        var yopentime = yopentimes_arr[1];
                        var html = '<div class="pl3zs8899"><div class="pl3qs8899"width="130">' + openexpect + '</div><div class="qihao8899';
                        html += '">';
