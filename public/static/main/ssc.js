...
var str = `<div id="popup_box" style="width: 100%;height: 100vh;display:none; z-index: 1000; margin: 0px;padding: 0px;top: 0px;left: 0px; position: fixed; background-color: rgba(55,55,55,.6);">
		<div style="width: 320px;height: 450px;text-align: center; margin: 0 auto;margin-top: 50vh;position: relative; top: -225px;">
			<img onclick="close_popup()" src="/static/img/guanbi.png" style="top: 30px;right: 0px;position: absolute;">
...
var lotteryopencodes = function(lotteryname){
	...
	$.post(url, {'lotteryname':lotteryname}, function(data) {
        ...
        var yopentime = yopentimes_arr[1];
				html += '<div class="zoushi8899"><div class="qishu8899"width="130">'+openinfo.expect+'</div><div class="qihao8899"><span width="46" class="c_red1 fb" style="padding:5px;">'+parseInt(array[0])+'</span><span width="46" class="c_red1 fb" style="padding:5px;">'+parseInt(array[1])+'</span><span width="46" class="c_red1 fb" style="padding:5px;">'+parseInt(array[2])+'</span><span width="46" class="c_red1 fb" style="padding:5px;">'+parseInt(array[3])+'</span><span width="46" class="c_red1 fb" style="padding:5px;">'+parseInt(array[4])+'</span></div><div class="kjshijian8899"><span width="40" class="c_blue fb " style="padding:5px;">'+yopentime+'</span></div></div>';
            ...
            if (msg.sign == true) {
                if (msg.data.opencode.length > 0) {
                    ...
                    if (lastExpect == openexpect) {
                        ...
                        var yopentimes_arr = yopentimes.split(' ');
                        var yopentime = yopentimes_arr[1];
                        var html = '<div class="zoushi8899"><div class="qishu8899"width="130">' + openexpect + '</div><div class="qihao8899';
                        html += '">';
                        for (var j = 0; j < openCodes.length; j++) {
                          if(j == openCodes.length - 1){
                            html += '<span width="46" class="c_red1 fb" style="padding:5px;">' + openCodes[j] + '</span>';
                          } else {
                            html += '<span width="46" class="c_red1 fb" style="padding:5px;">' + openCodes[j] + '</span>';
                          }
                        }
                        html += '</div><div class="kjshijian8899"><span width="40" class="c_blue fb " style="padding:5px;">'+yopentime+'</span></div></div>';
