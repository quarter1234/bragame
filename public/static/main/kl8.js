...
var lotteryopencodes = function(lotteryname){
	...
	$.post(url, {'lotteryname':lotteryname}, function(data) {
        ...
        var yopentime = yopentimes_arr[1];
				html += '<div class="k8zs8899"><div class="k8qs8899" width="130">'+openinfo.expect+'</div><div class="k8qh8899"><span width="46" class="k8c_red fb">'+parseInt(array[0])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[1])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[2])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[3])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[4])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[5])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[6])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[7])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[8])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[9])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[10])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[11])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[12])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[13])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[14])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[15])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[16])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[17])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[18])+'</span><span width="46" class="k8c_red fb">'+parseInt(array[19])+'</span></div><span class="" width="40" class="c_blue fb " style="width: 30%;text-align: center;float: left;min-height: 30px;line-height: 129px;word-wrap: break-word;">'+yopentime+'</span></div>';
            ...
            if (msg.sign == true) {
                if (msg.data.opencode.length > 0) {
                    ...
                    if (lastExpect == openexpect) {
                        ...
                        var yopentimes_arr = yopentimes.split(' ');
                        var yopentime = yopentimes_arr[1];
                        var html = '<div class="k8zs8899"><div class="k8qs8899" width="130">' + openexpect + '</div><div class="k8qh8899';
                        html += '">';
                        for (var j = 0; j < openCodes.length; j++) {
                          if(j == openCodes.length - 1){
                            html += '<span width="46" class="k8c_red fb">' + openCodes[j] + '</span>';
                          } else {
                            html += '<span width="46" class="k8c_red fb">' + openCodes[j] + '</span>';
                          }
                        }
                        html += '</div><span class="" width="40" class="c_blue fb " style="width: 30%;text-align: center;float: left;min-height: 30px;line-height: 129px;word-wrap: break-word;">'+yopentime+'</span></div>';
