	...
	$node.html('');
	  $.post(url, {'lotteryname':lotteryname}, function(data) {
        ...
        var yopentime = yopentimes_arr[1];
				html += '<tr><td>'+openinfo.expect+'</td><td class="c_red fb" style="padding:5px;width: 160px;">'+lhckaijList+'</td><td width="40" class="c_blue fb" style="padding:5px;">'+yopentime+'</td></tr>';
            ...
            if (msg.sign == true) {
                if (msg.data.opencode.length > 0) {
                    ...
                    if (lastExpect == openexpect) {
                        ...
                        var yopentimes_arr = yopentimes.split(' ');
                        var yopentime = yopentimes_arr[1];
                        var html = '<tr><td class="lsqh">' + openexpect + '</td><td style="padding:5px;width: 160px;" class="c_red fb';
                        html += '">';
                        html += lhckaijList;
