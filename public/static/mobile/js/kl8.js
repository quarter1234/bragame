    ...
    var strspan = "";
        ...
        var yopentime = yopentimes_arr[1];
            ...
            arr = array;
				...
				html += '<tr><td >'+openinfo.expect+'<br>'+yopentime+'</td><td class="c_red fb" style="padding:5px;color:red;"><div style="width:230px;">'+strspan+'</div></td></tr>';
            ...
            if (msg.sign == true) {
				...
				for(var a in arr){
					strspan+="<span>"+arr[a]+"</span>";
                        ...
                        html += '<tr><td >'+openexpect+'<br>'+yopentime+'</td><td class="c_red fb" style="padding:5px;color:red;"><div style="width:230px;">'+strspan+'</div></td></tr>';
