...
var lotteryopencodes = function(lotteryname){
	...
	$.post(url, {'lotteryname':lotteryname}, function(data) {
        ...
        strspan = "";
				...
				html += '<tr><td width="" >'+openinfo.expect+'</td><td class="on" width="" class="c_red fb" style="padding:5px;color:red;">'+strspan+'</td><td width="40" class="c_blue fb" style="padding:5px;">'+yopentime+'</td></tr>';
         ...
         success:function(msg){ 
            if (msg.sign == true) {
				...
				for(var a in arr){
                        ...
                        html += '<tr><td width="" >'+openexpect+'</td><td class="on" width="" class="c_red fb" style="padding:5px;color:red;">'+strspan+'</td><td width="40" class="c_blue fb" style="padding:5px;">'+yopentime+'</td></tr>';
