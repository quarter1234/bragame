...
// lhc_red_bg
  ...
  function lhclmgameNumber(arr,beis){
    var box = $('.g_Number_Section');
    var boxList = $('<div class="selectNumbers lhclm" style="padding: 0 15px;overflow: hidden;"></div>');
    var beisArr = beis.split('|');
    if(_thisPlayid == 'tmbb' || _thisPlayid == 'sxtx' ||　_thisPlayid == 'sx1x'){
      for(var j = 0; j < arr.length; j++){
        var tmbbArr = arr[j].split('|');
        boxList.append('<div style="width: 97px;margin: 8px 5px;display: inline-block;float: left;border-radius: 4px;background: #404b5e;">'+
          '<a href="javascript:void(0);" style="color: #cccccc;border:none;width: 100%;margin: 0;" class="selectNumber lhctmbbselectNumber" data-number="'+tmbbArr[0]+'">'+tmbbArr[0]+
      ...
      for(var j = 0; j < arr.length; j++){
        var tmbbArr = arr[j].split('|');
        boxList.append('<div style="width: 97px;margin: 8px 5px;display: inline-block;float: left;border-radius: 3px;background: #404b5e;;">'+
          '<a href="javascript:void(0);" style="color: #cccccc;border:none;width: 100%;margin: 0;"  class="selectNumber lhctmbbselectNumber" data-bg="lhc_sx_bg" data-number="'+tmbbArr[0]+'">'+tmbbArr[0]+
          '<div class="lmbbNumber"  style="font-size: 10px;color: #888;    height: 24px;">'+tmbbArr[1]+'</div></a>'+
        '</div>');
      }
      ...
      for(var j = 0; j < arr.length; j++){
        boxList.append('<div style="width: 60px;margin: 8px 10px;display: inline-block;float: left;text-align: center;">'+
          ...
          '<span class="lhclmPeil" style="font-size: 10px;background: none;color: #cccccc !important;">赔率<em>'+beisArr[j]+'</em></span>'+
        '</div>');
      }
    }
    box.append(boxList);
