        ...
        var yopentime = yopentimes_arr[1];
         arr = openinfo.opencode.split(',');
          strspan = "";
				...
				html += '<tr><td width="" >'+openinfo.expect+'<br>'+yopentime+'</td><td class="on" width="" class="c_red fb" style="padding:5px;color:red;">'+strspan+'</td></tr>';
	 ...
	 $.ajax({  
         ...
         success:function(msg){ 
            if (msg.sign == true) {
				...
				html="";
				html += '<tr><td width="" >'+openexpect+'<br>'+yopentime+'</td><td class="on" width="" class="c_red fb" style="padding:5px;color:red;">'+strspan+'</td></tr>';
