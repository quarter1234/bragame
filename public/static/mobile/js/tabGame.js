$(function () {
    ...
    var _thisPlayid = '';
    var wxGetMaxMoney = { //每种玩法的可中金额 f_submit_order
        wx_fs: 192000.00,
        wx_zx120: 1600.00,
        wx_zx60: 3200.00,
        wx_zx30: 6400.00,
    ...
    function gameNumberZxbd(arr, type) {
        console.log(JSON.stringify(yrates));
        ...
        for (var i = 0; i < arr.length; i++) {
            ...
            if (type == 'dxds') {
                for (var j in dxdsObj) {
                    boxNumber.append('<a href="javascript:void(0);" class="selectNumber on" data-number="' + j + '">' + dxdsObj[j] + '</a>');
                }
            } else {
                for (var j = 0; j <= 9; j++) {
                    boxNumber.append('<a href="javascript:void(0);" class="selectNumber on" data-number="' + j + '">' + j + '</a>');
                }
            }
    ...
    function gameNumberLH(arr,type){
        ...
        for(var i = 0;i<arr.length;i++){
            ...
            if (type == 'lh') {
                for (var j in lhObj) {
                    boxNumber.append('<a href="javascript:void(0);" class="selectNumber on" data-number="' + j + '">' + lhObj[j] + '</a>');
                }
            } else {
                for (var j = 0; j <= 9; j++) {
                    boxNumber.append('<a href="javascript:void(0);" class="selectNumber on" data-number="' + j + '">' + j + '</a>');
