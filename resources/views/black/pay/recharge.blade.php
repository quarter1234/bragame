  ...
  <body style="color: white; background-color: #0a0e2b;">
   ...
   $(function(){
      ...
      $('.recharge_k1').click(function(){
        ...
        let payCoin = $('.re_show').eq(index).children('.recharge_kn .recharge_k, .recharge_on').attr('payCoin')
        console.log(payCoin)
        let rate = $('.re_show').eq(index).children('.recharge_kn .recharge_k, .recharge_on').attr('rate')
        let id = $('.re_show').eq(index).children('.recharge_kn .recharge_k, .recharge_on').attr('itemId')
        $('#recharge_value').val(payCoin)
        $('#recharge_rate').text(rate)
        $("#recharge_id").val(id)
      })
