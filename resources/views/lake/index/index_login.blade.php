<style>
    ...
    @media screen and (min-width: 1200px){
      .tc{ width:40%;height:410px;position:fixed;top:50%;z-index:999; border-radius:10px 10px 0 0; background:#000;margin-top:-205px;left:50%;margin-left:-20%;}
  ...
  <div class="close"><img src="/mobile/lake/images/gb_black.png"></div>      
      <div class="tc_top">
      ...
      <div class="list" style="display:block;">
          ...
          <div class="entry">
                  ...
                  <div class="sr_close"><img src="https://www.betbra.net:8032/bx_1/public/static/images/close.png"></div>
              </div>
              <div class="pass">
                <div class="email"><img src="https://www.betbra.net:8032/bx_1/public/static/images/pass.png" /></div>
              ...
              <div class="remember">
                  <div class="remember_left">
                        <div class="r_left r2"><img src="/mobile/lake/images/25gf.png" />{{ trans('auth.remember_password') }}</div>
                        <div class="r_left r1"><img src="/mobile/lake/images/24gf.png" />{{ trans('auth.remember_password') }}</div>
