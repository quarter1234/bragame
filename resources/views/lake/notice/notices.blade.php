...
.header-view__nav-row-wrapper--gradient-lake[_ngcontent-iif-c3] {background-color:transparent;background-image:linear-gradient(to bottom,rgba(0,0,0,1),rgba(12,25,44,0))}
@supports ((webkit-backdrop-filter:none) or (backdrop-filter:none)) {.header-view__nav-row-wrapper--gradient[_ngcontent-iif-c3],.header-view__nav-row-wrapper--gradient-lake[_ngcontent-iif-c3] {webkit-backdrop-filter:none;backdrop-filter:none}
}
...
.header-view__footer-row-wrapper--gradient-lake[_ngcontent-iif-c3] {background-color:transparent;background-image:linear-gradient(to top,rgba(0,0,0,1),rgba(19,34,53,0))}
@supports ((webkit-backdrop-filter:none) or (backdrop-filter:none)) {.header-view__footer-row-wrapper--gradient[_ngcontent-iif-c3],.header-view__footer-row-wrapper--gradient-lake[_ngcontent-iif-c3] {webkit-backdrop-filter:none;backdrop-filter:none}
}
