...
<div class="xk_b">
    ...
    <p>1. Enlace de invitación Copie su enlace de recomendación en la interfaz principal para compartir y compártelo, de modo que los miembros registrados se conviertan en sus agentes directos y los miembros de nivel inferior que inviten se consideren miembros de su equipo.</p>
    <p>2. Recomienda que más jugadores interactúen juntos, invita a jugadores mayores de 18 años.</p>    
</div>
...
<div class="yh_table">
    ...
    <div style="width:100%;text-align:center;margin-top:1rem">
        <button id="invite_load_more" page="0" onclick="loadInvites()"  style="color:#fff; font-size:14px;padding: 5px 10px;background:rgba(0, 0, 0, .2);border-radius: 5px;font-size: 14px;">{{--点击加载更多--}}Cargar más</button>
    </div>
    <div class="index_bottom" style='margin: 20px  auto 0 auto;'>
