<html lang="zh-Hans">
  ...
  <head>
    ...
    .other-live-ctn[_ngcontent-avh-c16] {width: 95%;}
    .other-live-ctn[_ngcontent-avh-c16] .other-live[_ngcontent-avh-c16] {width:30%;border-radius:10px;margin-bottom:20px} 
    .other-live-ctn[_ngcontent-avh-c16] .other-live[_ngcontent-avh-c16]:nth-child(odd) {} 
	...
	.slot-btns-ctn[_ngcontent-avh-c17] {display:flex;flex-flow:column;width: 95%;}
	.game-btn-holder[_ngcontent-avh-c17] {display:flex;justify-content:space-between;flex-flow:row wrap;width: 95%;}
	...
	<style>.other-btns-ctn[_ngcontent-avh-c18] {display:flex;flex-flow:column;width: 95%;}
	...
	<style>.fishing-game-board-ctn[_ngcontent-avh-c19] {display:flex;flex-flow:column wrap;width: 95%; justify-content:space-between;}
