        ...
        @include('brling.common.top') 
            ...
            <div class="centen_tab">
                  <div class="centen_list centen_on">
                      <img src="https://bxgames3.s3.sa-east-1.amazonaws.com/bx_1/public/brling/img/fx.png" />
                      <p>Convidar{{--分享--}}</p>
                  </div>
                  <div class="centen_list">
                      <img src="https://bxgames3.s3.sa-east-1.amazonaws.com/bx_1/public/brling/img/dl.png" style="width:35px;height:35px;margin:-2px 0 -20px 0;" />
                      <p>Agente{{--代理--}}</p>
                  </div>
                  <div class="centen_list">
                      <img src="https://bxgames3.s3.sa-east-1.amazonaws.com/bx_1/public/brling/img/flzh.png" />
                      <p>Membro {{--成员--}}</p>
                  </div>
            </div>
