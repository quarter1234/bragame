<div class="xk">
    ...
    <div class="xk_t">
        ...
        <button id="btn"><img src="https://bxgames3.s3.sa-east-1.amazonaws.com/bx_1/public/drling/img/fz.png" /></button>
    </div>
    <p style="padding-top:10px;">O código de convite{{--邀请码--}}</p>
    <div class="xk_t">
        <input type="text" value="{{$user['code']}}" id="demoInput2" />
        <button id="btn2"><img src="https://bxgames3.s3.sa-east-1.amazonaws.com/bx_1/public/drling/img/fz.png" /></button>
    </div>
</div>
<div class="xk_b">
    <img src="https://bxgames3.s3.sa-east-1.amazonaws.com/bx_1/public/drling/img/share_bottom.png" />
