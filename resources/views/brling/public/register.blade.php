...
<script src="/static/mobile/js/require.js" data-main="/static/mobile/js/main"></script>
</head>
<body>
    <div class="Wap RegisterBg">
<header>
    <div class="h_container">
      <div class="jx-logo_mobile"><a href="#"><img src="/static/img/mobile_logo.png"></a></div>
    </div>
  </header>
        <div id="Container">
...
>>>>>>> a0eae707048c0c2095d544dd0d575b0763b4be2a
        ...
        <div class="adv_banner_mobile"><img src="/static/img/banner_register.jpg"></div>
<div id="MainFt">
    <ul class="FtFrame">
        <li class="pay_mobile"><a href="#"><img src="/static/img/flogo1.png"></a></li>
        <li class="pay_mobile"><a href="#"><img src="/static/img/flogo2.png"></a></li>
        <li class="pay_mobile"><a href="#"><img src="/static/img/flogo3.png"></a></li>
        <li class="pay_mobile"><a href="#"><img src="/static/img/flogo4.png"></a></li>
    </ul>
