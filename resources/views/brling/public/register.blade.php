...
<script src="/static/brling/js/require.js" data-main="/static/brling/js/main"></script>
</head>
<body>
    <div class="Wap RegisterBg">
<header>
    <div class="h_container">
      <div class="jx-logo_brling"><a href="#"><img src="/static/img/brling_logo.png"></a></div>
    </div>
  </header>
        <div id="Container">
        ...
        <div class="adv_banner_brling"><img src="/static/img/banner_register.jpg"></div>
<div id="MainFt">
    <ul class="FtFrame">
        <li class="pay_brling"><a href="#"><img src="/static/img/flogo1.png"></a></li>
        <li class="pay_brling"><a href="#"><img src="/static/img/flogo2.png"></a></li>
        <li class="pay_brling"><a href="#"><img src="/static/img/flogo3.png"></a></li>
        <li class="pay_brling"><a href="#"><img src="/static/img/flogo4.png"></a></li>
    </ul>
