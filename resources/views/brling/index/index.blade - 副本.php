<html lang="zh-Hans">
  ...
  <head>
	...
	.game-sa[_ngcontent-avh-c16] {background-image:url(/mobile/img/ae.png)}
	.game-dg[_ngcontent-avh-c16] {background-image:url(/mobile/img/dg.png)}
	.game-og[_ngcontent-avh-c16] {background-image:url(/mobile/img/og.png)}
	.game-bg[_ngcontent-avh-c16] {background-image:url(/mobile/img/bg.png)}
	.game-allbet[_ngcontent-avh-c16] {background-image:url(/mobile/img/allbet.png)}
	.game-bbvideo[_ngcontent-avh-c16] {background-image:url(/mobile/img/bbvideo.png)}</style>
	<style>.jx-slot[_ngcontent-avh-c17] {background-image:url(/mobile/img/999001.dbb253d4b1149f3efee6.png);border-radius:10px;margin-bottom:10px;padding-bottom:calc((100% * 113 / 314))}
	...
	.game-999010[_ngcontent-avh-c17] {background-image:url(/mobile/img/999010.1aeeaeb022dc7811eba2.png)}
	.game-999011[_ngcontent-avh-c17] {background-image:url(/mobile/img/999011.6b074fb8a5f1fb867d20.png)}
	.game-jdb[_ngcontent-avh-c17] {background-image:url(/mobile/img/jdb.png)}
	.game-sg[_ngcontent-avh-c17] {background-image:url(/mobile/img/sg.png)}
	</style>
	...
	.game-888001[_ngcontent-avh-c18] {background-image:url(/mobile/img/888001.7f42bfe3ee80d1c8e8cb.png)}
	.game-agti[_ngcontent-avh-c18] {background-image:url(/mobile/img/agti.png)}
	.game-bbti[_ngcontent-avh-c18] {background-image:url(/mobile/img/bbti.png)}
	.game-gj[_ngcontent-avh-c18] {background-image:url(/mobile/img/gj.png)}
	.game-ky[_ngcontent-avh-c18] {background-image:url(/mobile/img/ky.png)}
	.game-rmg[_ngcontent-avh-c18] {background-image:url(/mobile/img/rmg.png)}
	.game-mt[_ngcontent-avh-c18] {background-image:url(/mobile/img/mt.png)}
	.game-nw[_ngcontent-avh-c18] {background-image:url(/mobile/img/nw.png)}
	.game-999008[_ngcontent-avh-c18] {background-image:url(/mobile/img/avia.png)}
	.game-999009[_ngcontent-avh-c18] {background-image:url(/mobile/img/bbnew.png)}
	.game-esb[_ngcontent-avh-c18] {background-image:url(/mobile/img/esb.png)}
	</style>
	...
	.fishing-game-999006[_ngcontent-avh-c19] {background-image:url(/mobile/img/bbby.png)}
	.fishing-game-bgby[_ngcontent-avh-c19] {background-image:url(/mobile/img/bgby.png)}
	.fishing-game-999013[_ngcontent-avh-c19] {background-image:url(/mobile/img/999013.bcca34c8f027fb828449.png)}
</style>
