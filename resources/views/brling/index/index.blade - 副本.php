<html lang="zh-Hans">
  ...
  <head>
    ...
    <style>button.bulletin-board-btn[_ngcontent-way-c6] {display:block;margin:0;padding:8px 15px;width:100%;border-radius:0;color:#fff} div.bulletin-board-container[_ngcontent-way-c6] {box-sizing:border-box;height:20px;display:flex;flex-flow:row nowrap;justify-content:space-between;align-items:center} div.bulletin-icon[_ngcontent-way-c6] {flex:0 0 auto;width:20px;height:20px;background-size:contain;background-repeat:no-repeat;background-position:center center;background-image:url(/drling/img/bulletin-icon.a996c907273958ac2d65.svg)} .more-announcement-icon[_ngcontent-way-c6] {flex:0 0 auto;width:70px;height:100%;background-size:contain;background-repeat:no-repeat;background-position:center center;background-image:url(/drling/img/more-announcement.e9aba3242f773db1453a.png)} div.bulletin-board[_ngcontent-way-c6] {flex:1 1 auto;margin-left:1em;height:20px;overflow:hidden;text-align:start;font-size:14px;font-weight:400;color:#878e97;line-height:20px}</style>
    <style>div.util-bar-container[_ngcontent-way-c7] {padding:0 10px 10px;display:flex;flex-flow:row nowrap;justify-content:space-between;align-items:center} .daily-gift[_ngcontent-way-c7] {flex:1 0 auto;max-width:50%} .daily-gift-title-row[_ngcontent-way-c7] {display:flex;flex-direction:row;height:24px;align-items:center;margin-bottom:4px} .daily-gift-username-title[_ngcontent-way-c7] {color:#7998b1;font-size:12px;margin-right:8px;text-overflow:ellipsis;overflow:hidden;white-space:nowrap} .daily-gift-logo[_ngcontent-way-c7] {background-image:url(/drling/img/bgDailyGift.f36b818e9b284312109a.png);background-repeat:no-repeat;background-position:center;background-size:contain;min-width:70px;height:100%} .daily-gift-logo-title[_ngcontent-way-c7] {margin-left:27px;white-space:nowrap;font-family:"PingFangSC-Medium,PingFang SC";font-size:9px;color:#fff} .daily-gift-value[_ngcontent-way-c7] {font-size:19px;width:100%} .daily-gift-value-sign[_ngcontent-way-c7] {font-size:12px} .util-bar[_ngcontent-way-c7] {flex:1 0 auto;display:flex;justify-content:space-between;margin-left:auto;margin-right:16 px;max-width:50%} button.util-btn[_ngcontent-way-c7] {padding:0;width:50px;height:50px;color:#7998b1;font-size:12px;display:inline-flex;flex-flow:column nowrap;justify-content:space-between;align-items:center} span.util-btn-icon[_ngcontent-way-c7] {display:block;width:25px;height:25px;background-size:contain;background-repeat:no-repeat;background-position:center center} span.util-btn-icon.deposit[_ngcontent-way-c7] {background-image:url(/drling/img/deposit.862cd26ec57e83f225c4.png)} span.util-btn-icon.transfer[_ngcontent-way-c7] {background-image:url(/drling/img/transfer.a1c5b153615b288c7824.png)} span.util-btn-icon.withdraw[_ngcontent-way-c7] {background-image:url(/drling/img/withdraw.a41c76f1715915566d01.png)} span.util-btn-icon.ac[_ngcontent-way-c7] {background-image:url(/drling/img/ac.6e82c2d8f893679d58fb.png)} div.cs-dialog-icon[_ngcontent-way-c7] {display:block;width:99px;height:92px;background-size:contain;background-repeat:no-repeat;background-position:center center;background-image:url(cs_img.c95648a5d29ec2d84117.svg)} div.cs-dialog-title[_ngcontent-way-c7] {margin-top:22px;color:#333;font-size:24px;font-weight:500}</style>
    <style>.home-game-board-ctn[_ngcontent-way-c8] {display:flex;flex-flow:row nowrap} .side-menu-ctn[_ngcontent-way-c8] {margin-left:10px;display:flex;flex-flow:column nowrap;align-items:center;justify-content:flex-start} .side-menu-item[_ngcontent-way-c8] {display:flex;flex-flow:row nowrap;align-items:center;justify-content:center;width:100%;box-sizing:border-box;margin:0 0 5px;padding:10px;font-size:12px;color:#7998b1;background-size:cover;background-repeat:no-repeat;background-position:center;background-image:url(bg.bb9d51fea2a2599c8737.png)} .side-menu-item__tag[_ngcontent-way-c8] {white-space:nowrap} .active-side-menu[_ngcontent-way-c8] {color:#fff;background-image:url(/drling/img/bg_active.4290af043bcec3617ad5.png)} .side-menu-item__icon[_ngcontent-way-c8] {background-size:cover;background-repeat:no-repeat;background-position:center;width:24px;padding-bottom:24px;margin-right:5px} .game-board-ctn[_ngcontent-way-c8] {margin:0 10px;width:100%} .side-menu-icon-lottery[_ngcontent-way-c8] {background-image:url(/drling/img/lottery.45d67018e32eec8b862c.png)} .side-menu-icon-lottery.active-side-menu-icon[_ngcontent-way-c8] {background-image:url(/drling/img/lottery_active.88066d8dcaf479878e64.png)} .side-menu-icon-live[_ngcontent-way-c8] {background-image:url(/drling/img/live.3be00c21be6f02e81489.png)} .side-menu-icon-live.active-side-menu-icon[_ngcontent-way-c8] {background-image:url(/drling/img/live_active.a0070344ba437bf32dea.png)} .side-menu-icon-slot[_ngcontent-way-c8] {background-image:url(/drling/img/slot.8c1c064dca40f3e255e7.png)} .side-menu-icon-slot.active-side-menu-icon[_ngcontent-way-c8] {background-image:url(/drling/img/slot_active.9725d9aea1b9d087c9b7.png)} .side-menu-icon-sport[_ngcontent-way-c8] {background-image:url(/drling/img/sport.56210547767ef73a4d32.png)} .side-menu-icon-sport.active-side-menu-icon[_ngcontent-way-c8] {background-image:url(/drling/img/sport_active.d66e7bcb8a1eeb5070c7.png)} .side-menu-icon-fishing[_ngcontent-way-c8] {background-image:url(/drling/img/fishing.149177d7d963fea179e2.png)} .side-menu-icon-fishing.active-side-menu-icon[_ngcontent-way-c8] {background-image:url(/drling/img/fishing_active.016cd2b3678134b02ace.png)} .side-menu-icon-boardgame[_ngcontent-way-c8] {background-image:url(/drling/img/boardgame.201c62bfbf568040859b.png)} .side-menu-icon-boardgame.active-side-menu-icon[_ngcontent-way-c8] {background-image:url(/drling/img/boardgame_active.eb4ce6f334b0fc8e9137.png)} .side-menu-icon-esport[_ngcontent-way-c8] {background-image:url(/drling/img/esport.a4eb4a91f21db4f5ee2c.png)} .side-menu-icon-esport.active-side-menu-icon[_ngcontent-way-c8] {background-image:url(/drling/img/esport_active.23c7638fe647fe2598c0.png)}</style>
    <style>.tab-bar[_ngcontent-way-c10] {box-sizing:content-box;min-height:49px;display:flex;flex-flow:row nowrap;justify-content:space-around;align-items:stretch} .tab-bar__nav-btn[_ngcontent-way-c10] {flex:1 1 0;min-height:49px;color:#5d636e;display:flex;flex-flow:column nowrap;justify-content:flex-start;align-items:center} .tab-bar__nav-btn--active[_ngcontent-way-c10] {color:#0b93ae} .tab-bar__nav-btn__icon[_ngcontent-way-c10] {flex:0 0 auto;display:block;margin-top:6px;width:24px;height:24px;background-size:contain;background-repeat:no-repeat;background-position:center} .tab-bar__nav-btn__icon--home[_ngcontent-way-c10] {background-image:url(/drling/img/home.93b20d6e835f71c043b8.png)} .tab-bar__nav-btn__icon--activity[_ngcontent-way-c10] {background-image:url(/drling/img/activity.8a6a35ba2ac648314ace.png)} .tab-bar__nav-btn__icon--cs[_ngcontent-way-c10] {background-image:url(/drling/img/datin.svg)} .tab-bar__nav-btn__icon--brand[_ngcontent-way-c10] {background-image:url(/drling/img/huodong.svg)} .tab-bar__nav-btn__icon--my[_ngcontent-way-c10] {background-image:url(/drling/img/my.87c43b85171cb8232892.png)} .tab-bar__nav-btn--active[_ngcontent-way-c10] > .tab-bar__nav-btn__icon--home[_ngcontent-way-c10] {background-image:url(/drling/img/active_home.485e6c98acecf897b8ba.png)} .tab-bar__nav-btn--active[_ngcontent-way-c10] > .tab-bar__nav-btn__icon--activity[_ngcontent-way-c10] {background-image:url(/drling/img/active_activity.0eee109d4b6a4ccedf91.png)} .tab-bar__nav-btn--active[_ngcontent-way-c10] > .tab-bar__nav-btn__icon--cs[_ngcontent-way-c10] {background-image:url(/drling/img/active_cs.9be7ce116557877dec91.png)} .tab-bar__nav-btn--active[_ngcontent-way-c10] > .tab-bar__nav-btn__icon--brand[_ngcontent-way-c10] {background-image:url(/drling/img/active_brand.26b0bef9602b57eac72e.png)} .tab-bar__nav-btn--active[_ngcontent-way-c10] > .tab-bar__nav-btn__icon--my[_ngcontent-way-c10] {background-image:url(/drling/img/active_my.030b4715dce6d516f9c8.png)} .tab-bar__nav-btn__title[_ngcontent-way-c10] {flex:0 0 auto;display:block;margin-top:6px;color:inherit;font-size:10px;font-weight:400;line-height:14px}</style>
    ...
    <style>.lottery-board-ctn[_ngcontent-way-c15] {display:flex;flex-flow:column wrap;justify-content:flex-start;height:40%} .lottery-btns-ctn[_ngcontent-way-c15] {display:flex;flex-flow:row wrap;margin-bottom:10px} .lottery-btn[_ngcontent-way-c15] {display:flex;flex-flow:column nowrap;align-items:center;width:25%;box-sizing:border-box;border-radius:0;padding:10px;font-size:12px;background-size:cover;background-repeat:no-repeat;background-position:center;background-image:url(/drling/img/lottery_bg.5b0db9f6401c9434ec75.png)} .title[_ngcontent-way-c15] {color:#a9bed8} .sub-title[_ngcontent-way-c15] {color:#7998b1} .lottery-btn[_ngcontent-way-c15]:first-child {border-radius:10px 0 0} .lottery-btn[_ngcontent-way-c15]:nth-child(4) {border-radius:0 10px 0 0} .lottery-btn[_ngcontent-way-c15]:nth-child(5) {border-radius:0 0 0 10px} .lottery-btn[_ngcontent-way-c15]:nth-child(8) {border-radius:0 0 10px} .lottery-btn-icon[_ngcontent-way-c15] {background-size:cover;background-repeat:no-repeat;background-position:center;width:50px;height:50px} .lottery-lobby[_ngcontent-way-c15] {background-size:cover;background-repeat:no-repeat;background-position:center;background-image:url(/drling/img/lottery_lobby.3ebc4b9cfc4f865db015.png);border-radius:10px;width:100%;padding-bottom:calc((100% * 144 / 314))} .game-1[_ngcontent-way-c15] {background-image:url(/drling/img/1.94732245082a337d973a.png)} .game-6[_ngcontent-way-c15] {background-image:url(/drling/img/6.f45183d305b4055e0491.png)} .game-26[_ngcontent-way-c15] {background-image:url(/drling/img/26.b99820baf827d5c86613.png)} .game-27[_ngcontent-way-c15] {background-image:url(/drling/img/27.b66a27dc46bf56e60c6a.png)} .game-28[_ngcontent-way-c15] {background-image:url(/drling/img/28.5004283522d159495603.png)} .game-32[_ngcontent-way-c15] {background-image:url(/drling/img/32.552f1aa9ef799e732bce.png)} .game-43[_ngcontent-way-c15] {background-image:url(/drling/img/43.c402a9fb3d3945ac39b8.png)} .game-45[_ngcontent-way-c15] {background-image:url(/drling/img/45.36dd88e459f576fea52e.png)}</style>
    ...
    <style>.live-game-board-ctn[_ngcontent-avh-c16] {display:flex;flex-flow:column}  .other-live-ctn[_ngcontent-avh-c16] {display:flex;justify-content:space-between;flex-flow:row wrap} 
    .other-live-ctn[_ngcontent-avh-c16] .other-live[_ngcontent-avh-c16] {width:calc(50% - 5px);border-radius:10px;margin-bottom:10px} 
    .other-live-ctn[_ngcontent-avh-c16] .other-live[_ngcontent-avh-c16]:nth-child(odd) {margin-right:10px} 
	
	.game-sa[_ngcontent-avh-c16] {background-image:url(/drling/img/ae.png)}
	.game-dg[_ngcontent-avh-c16] {background-image:url(/drling/img/dg.png)}
	.game-og[_ngcontent-avh-c16] {background-image:url(/drling/img/og.png)}
	.game-bg[_ngcontent-avh-c16] {background-image:url(/drling/img/bg.png)}
	.game-allbet[_ngcontent-avh-c16] {background-image:url(/drling/img/allbet.png)}
	.game-bbvideo[_ngcontent-avh-c16] {background-image:url(/drling/img/bbvideo.png)}</style>
	<style>.jx-slot[_ngcontent-avh-c17] {background-image:url(/drling/img/999001.dbb253d4b1149f3efee6.png);border-radius:10px;margin-bottom:10px;padding-bottom:calc((100% * 113 / 314))}
	.slot-btns-ctn[_ngcontent-avh-c17] {display:flex;flex-flow:column}
	.game-btn-holder[_ngcontent-avh-c17] {display:flex;justify-content:space-between;flex-flow:row wrap}
	.game-btn[_ngcontent-avh-c17] {padding-bottom:calc(((100% / 2 - 5px) * 108 / 152));width:calc(50% - 5px);border-radius:10px;margin-bottom:10px}
	.game-999010[_ngcontent-avh-c17] {background-image:url(/drling/img/999010.1aeeaeb022dc7811eba2.png)}
	.game-999011[_ngcontent-avh-c17] {background-image:url(/drling/img/999011.6b074fb8a5f1fb867d20.png)}
	.game-jdb[_ngcontent-avh-c17] {background-image:url(/drling/img/jdb.png)}
	.game-sg[_ngcontent-avh-c17] {background-image:url(/drling/img/sg.png)}
	</style>
	<style>.other-btns-ctn[_ngcontent-avh-c18] {display:flex;flex-flow:column}
	.other-btns-ctn[_ngcontent-avh-c18]   .game-btn[_ngcontent-avh-c18] {padding-bottom:calc((100% * 170 / 314));border-radius:10px;margin-bottom: 10px;}
	.game-888001[_ngcontent-avh-c18] {background-image:url(/drling/img/888001.7f42bfe3ee80d1c8e8cb.png)}
	.game-agti[_ngcontent-avh-c18] {background-image:url(/drling/img/agti.png)}
	.game-bbti[_ngcontent-avh-c18] {background-image:url(/drling/img/bbti.png)}
	.game-gj[_ngcontent-avh-c18] {background-image:url(/drling/img/gj.png)}
	.game-ky[_ngcontent-avh-c18] {background-image:url(/drling/img/ky.png)}
	.game-rmg[_ngcontent-avh-c18] {background-image:url(/drling/img/rmg.png)}
	.game-mt[_ngcontent-avh-c18] {background-image:url(/drling/img/mt.png)}
	.game-nw[_ngcontent-avh-c18] {background-image:url(/drling/img/nw.png)}
	.game-999008[_ngcontent-avh-c18] {background-image:url(/drling/img/avia.png)}
	.game-999009[_ngcontent-avh-c18] {background-image:url(/drling/img/bbnew.png)}
	.game-esb[_ngcontent-avh-c18] {background-image:url(/drling/img/esb.png)}
	</style>
	<style>.fishing-game-board-ctn[_ngcontent-avh-c19] {display:flex;flex-flow:column wrap}
	.fishing[_ngcontent-avh-c19] {border-radius:10px;margin-bottom:10px;padding-bottom:calc((100% * 169 / 314))}
	.fishing-game-999006[_ngcontent-avh-c19] {background-image:url(/drling/img/bbby.png)}
	.fishing-game-bgby[_ngcontent-avh-c19] {background-image:url(/drling/img/bgby.png)}
	.fishing-game-999013[_ngcontent-avh-c19] {background-image:url(/drling/img/999013.bcca34c8f027fb828449.png)}
</style>
<style>.winning-box{ width: 95%; margin: 50px auto; border-radius: 4px; position: relative; background:#234d6d; box-shadow: 1px 1px 3px rgba(0, 0, 0, .1); } .winning-box .myScroll{ height:177px; margin-bottom: 20px; padding:0px; overflow: hidden; } .myScroll ul{ overflow: hidden; } .myScroll > ul >li { line-height: 25px; height: 58px; width: 100%; border-bottom: 1px solid #0b2640; overflow: hidden; padding-left: 10px; position: relative; font-size: 14px; color: #a9bed8; } .myScroll > ul >li > b{ color: #a9bed8; display: block; } .myScroll > ul > li >em{ display: inline-block; color: #999; position: absolute; right: 10px; top: 15px; } .am-modal-dialog{width: 80%;} .am-modal-bd img{ width: 100%; }</style>
	</head>
            ...
            <div _ngcontent-way-c3="" class="header-view__nav-row-wrapper safe-area-top safe-area-left safe-area-right" jxsafearealeft="" jxsafearearight="" jxsafeareatop="">
              <jx-header-row _ngcontent-way-c3="" class="header-view__nav-row-wrapper__container" _nghost-way-c11="">
                <div _ngcontent-way-c3="" class="header-view__nav-row-wrapper__container__nav-row">
                  ...
                  <!---->
                  <div _ngcontent-way-c3="" class="header-view__nav-row-wrapper__container__nav-row__content"></div>
                  <!---->
                  <!---->
              ...
              <div _ngcontent-way-c3="" class="header-view__content-wrapper__content-container">
                <jx-safe-area _ngcontent-way-c1="" class="safe-area-top safe-area-bottom safe-area-left safe-area-right" style="display: block; box-sizing: border-box;">
                  <jx-banner-board _ngcontent-way-c1="" _nghost-way-c5="" class="ng-tns-c5-0 ng-star-inserted">
                    ...
                    <!---->
                    <!---->
                    <div _ngcontent-way-c5="" data-am-widget="slider" data-am-slider='{&quot;directionNav&quot;:false}' class="banner-board-wrapper ng-tns-c5-0 ng-trigger ng-trigger-fadeInOut ng-star-inserted">
                      <div _ngcontent-way-c5="" class="banner-board-container" style="touch-action: pan-y; user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
                        <div _ngcontent-way-c5="" class="banner-item-container ng-trigger ng-trigger-carousel" style="transform: translateX(-100%);">
                          <!---->
                          <!---->
                          <img _ngcontent-way-c5="" alt="Banner Image" class="banner-item ng-tns-c5-0 ng-star-inserted" src="/drling/img/rgbanner.jpg" style="">
                          <!---->
                          <img _ngcontent-way-c5="" alt="Banner Image" class="banner-item ng-tns-c5-0 ng-star-inserted" src="/drling/img/rgbanner.jpg" style="">
                          <!---->
                          <img _ngcontent-way-c5="" alt="Banner Image" class="banner-item ng-tns-c5-0 ng-star-inserted" src="/drling/img/rgbanner.jpg" style=""></div>
                      </div>
                    </div>
                  </jx-banner-board>
                    ...
                    <button _ngcontent-way-c6="" class="bulletin-board-btn" tabindex="0">
                      ...
                      <div _ngcontent-way-c6="" class="bulletin-board-container">
                        ...
                        <div _ngcontent-way-c6="" class="bulletin-board ng-tns-c6-1 ng-star-inserted">
                          <a href="{{ route('drling.notice.info', ['id' => 2])}}" style="text-align: start;font-size: 14px;font-weight: 400;color: #878e97;line-height: 20px;">
                          ...
                          <a _ngcontent-way-c6="" class="more-announcement-icon" href="{{url('drling/notices')}}"></a>
                      </div>
                    </button>
                  </jx-bulletin-board>
                      ...
                      <div _ngcontent-way-c7="" class="daily-gift">
                        <div _ngcontent-way-c7="" class="daily-gift-title-row">
                          ...
                          @if (Auth::check())
                            欢迎您，{{ $user['playername'] }}
                          @else 
                            您好， <a href="{{url('drling/login')}}" style="color:#7998b1;text-decoration: none;">请登录</a>  /  
                            <a href="{{url('drling/register')}}" style="color:#7998b1;text-decoration: none;">免费注册</a>
                          @endif
                          </div>
                    ...
                    <div _ngcontent-way-c8="" class="home-game-board-ctn">
                      ...
                      <div _ngcontent-way-c8="" class="game-board-ctn">
						...
						<div _ngcontent-avh-c18="" class="other-btns-ctn tab" id="tab4_content" style="display: none;">
							  ...
							  <button _ngcontent-avh-c18="" class="game-btn generic-background-image game-bbti ng-star-inserted" style="padding-bottom: calc(((100% / 2 - 5px) * 108 / 152));width: calc(50% - 5px);border-radius: 10px;margin-bottom: 10px;" onclick="location.href='{:U('Zhenren/login',array('plat_type'=>'newbb','game_type'=>4))}'"></button>
              ...
              <jx-footer-row _ngcontent-way-c1="" _nghost-way-c9="">
                <jx-tab-bar _ngcontent-way-c1="" _nghost-way-c10="">
                  <div _ngcontent-way-c10="" class="tab-bar safe-area-fix-bottom safe-area-fix-left safe-area-fix-right" jxsafeareafixbottom="" jxsafeareafixleft="" jxsafeareafixright="">
                    <button _ngcontent-way-c10="" class="tab-bar__nav-btn safe-area-fix-bottom safe-area-fix-left tab-bar__nav-btn--active" onclick="location.href='{:U('Index/index')}'" jxsafeareafixleft="" routerlink="/home" routerlinkactive="tab-bar__nav-btn--active" tabindex="0">
                      <span _ngcontent-way-c10="" class="tab-bar__nav-btn__icon tab-bar__nav-btn__icon--home"></span>
                      <span _ngcontent-way-c10="" class="tab-bar__nav-btn__title">首页</span></button>
                    <button _ngcontent-way-c10="" class="tab-bar__nav-btn safe-area-fix-bottom" onclick="location.href='{:U('Member/betRecord.a_item.1.do')}'" routerlinkactive="tab-bar__nav-btn--active" tabindex="0">
                      <span _ngcontent-way-c10="" class="tab-bar__nav-btn__icon tab-bar__nav-btn__icon--activity"></span>
                      <span _ngcontent-way-c10="" class="tab-bar__nav-btn__title">投注记录</span></button>
                    <button _ngcontent-way-c10="" class="tab-bar__nav-btn safe-area-fix-bottom" onclick="location.href='{:U('Index.lotteryHall')}'">
                      <span _ngcontent-way-c10="" class="tab-bar__nav-btn__icon tab-bar__nav-btn__icon--cs"></span>
                      <span _ngcontent-way-c10="" class="tab-bar__nav-btn__title">购彩大厅</span></button>
                    <button _ngcontent-way-c10="" class="tab-bar__nav-btn safe-area-fix-bottom" onclick="location.href='{:U('Index/youhui')}'">
                      ...
                      <span _ngcontent-way-c10="" class="tab-bar__nav-btn__title">优惠活动</span></button>
                    <button _ngcontent-way-c10="" class="tab-bar__nav-btn safe-area-fix-bottom safe-area-fix-right" onclick="location.href='{{url("drling/member/index")}}'" routerlinkactive="tab-bar__nav-btn--active" tabindex="0">
                      <span _ngcontent-way-c10="" class="tab-bar__nav-btn__icon tab-bar__nav-btn__icon--my"></span>
                      <span _ngcontent-way-c10="" class="tab-bar__nav-btn__title">我的</span></button>
                  </div>
                </jx-tab-bar>
              </jx-footer-row>
            </div>
