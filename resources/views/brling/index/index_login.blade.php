          ...
          <div class="entry">
              ...
              <div class="remember">
                  <div class="remember_left">
                        <div class="r_left r2"><img src="https://bxgames3.s3.sa-east-1.amazonaws.com/bx_1/public/static/images/25gf.png" />{{ trans('auth.remember_password') }}</div>
                        <div class="r_left r1"><img src="https://bxgames3.s3.sa-east-1.amazonaws.com/bx_1/public/static/images/24gf.png" />{{ trans('auth.remember_password') }}</div>
