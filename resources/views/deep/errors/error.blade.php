...
.header-view__nav-row-wrapper--gradient-deep[_ngcontent-uwv-c2] {background-color:transparent;background-image:linear-gradient(to bottom,rgba(0,0,0,1),rgba(12,25,44,0))}
@supports ((webkit-backdrop-filter:none) or (backdrop-filter:none)) {.header-view__nav-row-wrapper--gradient[_ngcontent-uwv-c2],.header-view__nav-row-wrapper--gradient-deep[_ngcontent-uwv-c2] {webkit-backdrop-filter:none;backdrop-filter:none}
}
...
.header-view__footer-row-wrapper--gradient-deep[_ngcontent-uwv-c2] {background-color:transparent;background-image:linear-gradient(to top,rgba(0,0,0,1),rgba(19,34,53,0))}
@supports ((webkit-backdrop-filter:none) or (backdrop-filter:none)) {.header-view__footer-row-wrapper--gradient[_ngcontent-uwv-c2],.header-view__footer-row-wrapper--gradient-deep[_ngcontent-uwv-c2] {webkit-backdrop-filter:none;backdrop-filter:none}
}
