		...
		if(data.sign==true){
			...
			for(var o in lotlist){
				...
				if(sum%2!=0)
					...
					html += '<div class="zoushi8899"><div class="qishu8899" width="130">'+openinfo.expect+'</div><div class="qihao88999"><span width="46" class="c_red3 fb">'+parseInt(array[0])+'</span><span width="46" class="c_red3 fb">'+parseInt(array[1])+'</span><span width="46" class="c_red3 fb">'+parseInt(array[2])+'</span></div><div class="hezhi8899" width="40" class="c_blue fb">'+sum+'</div><div class="danshuang8899">'+smallbig+'&nbsp;|&nbsp;'+oddeven+'</div></div>';
                ...
                if (msg.data.opencode.length > 0) {
                    ...
                    if (lastExpect == openexpect) {
						...
						if(sum%2!=0)
							...
							oddeven='<em class="bg_blue">双</em>';
						var html = '<div class="zoushi8899"><div class="qishu8899" width="130">' + openexpect + '</div><div class="qihao88999';
						...
						for (var j = 0; j < openCodes.length; j++) {
							if(j == openCodes.length - 1){
								html += '<span width="46" class="c_red3 fb">' + openCodes[j] + '</span>';
							} else {
								html += '<span width="46" class="c_red3 fb">' + openCodes[j] + '</span>';
							}
						}
						...
						html += '</div><div class="hezhi8899" width="40" class="c_blue fb">'+sum+'</div><div class="danshuang8899">'+smallbig+'&nbsp;|&nbsp;'+oddeven+'</div></div>';
